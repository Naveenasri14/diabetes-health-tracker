...
class Command(BaseCommand):
    help = 'Load exact meal data from Soniya\'s database'
  ...
  },
  {
    ...
    "tamil_nadu_region": "All regions"
        ...
        for meal in meals:
            ...
            if created:
                count += 1
                self.stdout.write(self.style.SUCCESS(f'✓ Added: {meal["name"]}'))

        self.stdout.write(self.style.SUCCESS(f'\n✅ Successfully added {count} meal options!'))
        self.stdout.write(self.style.SUCCESS(f'📊 Total meals now: {DietSuggestion.objects.count()}'))